...
function Contact() {
  return (
    <motion.section initial={{y:'200vh'}} animate={{y:0}} transition={{delay:1, duration:1.5}} class="text-gray-600 body-font relative">
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <a class="text-indigo-500">sahoovicky200127@gmail.com</a>
          <p class="leading-normal my-5 text-white">Manchester
            <br/>
          </p>
